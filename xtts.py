"""Compatibility shim for the legacy `xtts` module."""
...
if __name__ == "__main__":
    runpy.run_module("xtts_stream.core.xtts", run_name="__main__")
else:
    _module = __import__("xtts_stream.core.xtts", fromlist=["*"])
