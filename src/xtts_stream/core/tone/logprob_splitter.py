...
class StreamingLogprobSplitter:
    ...
    SILENCE_THRESHOLD = 0.1  # probability (0 - 1)
    MIN_SILENCE_DURATION = 5  # in acoustic frames
    SPEECH_EXPAND_SIZE = 5  # in acoustic frames
    MAX_PHRASE_DURATION = 500  # in acoustic frames
