...
model specific calls and the websocket layer exposed by :mod:`xtts_stream.api.service`.
...
4. Update :mod:`xtts_stream.api.service.app` so it imports and instantiates your new
